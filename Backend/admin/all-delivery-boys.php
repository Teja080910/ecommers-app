...
$stmt = $pdo->prepare("
    ...
    FROM delivery_boys
    LEFT JOIN seller 
    ON seller.id = delivery_boys.seller_id
    ...
    <div class="delivery-table">
        ...
        <div class="table-row">
            ...
            <div class="small-text">
                ...
                <?php echo htmlspecialchars($boy['franchise_name']); ?>
            ...
            <div class="action-buttons">
                ...
                <a 
                    href="edit-delivery-boy.php?id=<?php echo $boy['id']; ?>"
                    class="edit-btn"
                >
                ...
                <a 
                    href="all-delivery-boys.php?delete=<?php echo $boy['id']; ?>"
                    class="delete-btn"
                    onclick="return confirm('Delete delivery boy?')"
                >
