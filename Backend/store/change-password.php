...
if(isset($_POST['change_password'])){
    ...
    if(!$franchise){
        ...
        if(!password_verify($current_password,$franchise['password'])){
            ...
            $update = $pdo->prepare("UPDATE seller SET password=? WHERE id=?");
...
<div class="main-content">
    ...
    <div class="page-header">
        ...
        <p>
            Update your franchise account password securely
        </p>
    ...
    <div class="form-box">
        ...
        <div class="security-box">
            ...
            <p>
                ...
                Never share your franchise password with anyone.
            </p>
